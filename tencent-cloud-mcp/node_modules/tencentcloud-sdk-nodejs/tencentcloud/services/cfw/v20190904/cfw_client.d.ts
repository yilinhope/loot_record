...
import { ModifyEWRuleStatusResponse, DescribeNatFwInstanceRequest, DescribeNatFwInstanceWithRegionRequest, DescribeLogsRequest, ModifyFwGroupSwitchRequest, ModifySecurityGroupRuleRequest, ModifyAssetSyncResponse, ModifyNatFwVpcDnsSwitchResponse, UpdateCheckCcnNonDirectFlagRequest, DescribeBlockIgnoreListResponse, CreateBlockIgnoreRuleNewRequest, ModifyIpsModeSwitchResponse, DescribeCcnInstanceRegionStatusRequest, DescribeRuleOverviewResponse, ModifyEnterpriseSecurityGroupRuleResponse, ModifySequenceRulesRequest, DescribeNatAcRuleResponse, UpdateClusterVpcFwRequest, AddAclRuleRequest, DescribeVpcFwGroupSwitchRequest, CreateAlertCenterIsolateResponse, ModifyNatAcRuleRequest, ModifyAclRuleRequest, ModifyAcRuleResponse, ModifyAssetScanResponse, ModifyNatSequenceRulesRequest, DescribeAclRuleResponse, DescribeNatFwInstanceWithRegionResponse, DescribeTLogInfoRequest, ModifyFwGroupSwitchResponse, DeleteNatFwInstanceResponse, ModifyBlockIgnoreRuleRequest, SearchLogResponse, DeleteBlockIgnoreRuleNewResponse, DescribeEnterpriseSGRuleProgressResponse, ModifyEdgeIpSwitchRequest, CreateChooseVpcsRequest, DescribeNatFwVpcDnsLstRequest, DescribeCfwEipsRequest, DescribeTLogInfoResponse, DescribeUnHandleEventTabListRequest, ModifyAllPublicIPSwitchStatusRequest, ModifyNatInstanceRequest, DescribeNatFwDnatRuleRequest, DescribeAssociatedInstanceListResponse, CreateBlockIgnoreRuleListRequest, RemoveAcRuleResponse, ModifyAddressTemplateRequest, DescribeAclRuleRequest, ModifyClusterVpcFwSwitchResponse, CreateSecurityGroupRulesResponse, ExpandCfwVerticalRequest, DescribeCcnVpcFwPolicyLimitResponse, ModifyAllPublicIPSwitchStatusResponse, SyncFwOperateRequest, ModifyAssetScanRequest, ModifyBlockIgnoreListRequest, AddEnterpriseSecurityGroupRulesRequest, ModifySecurityGroupSequenceRulesResponse, DeleteSecurityGroupRuleResponse, ModifyIpsModeSwitchRequest, ModifyNatFwSwitchResponse, ModifyAclRuleResponse, CreateNatFwInstanceRequest, ModifySecurityGroupItemRuleStatusResponse, DescribeEnterpriseSecurityGroupRuleResponse, DeleteBlockIgnoreRuleListResponse, CreateVpcFwGroupResponse, DescribeEnterpriseSecurityGroupRuleRequest, CreateAlertCenterRuleRequest, ModifyNatFwReSelectResponse, CreateAlertCenterOmitRequest, DescribeVpcFwCcnPolicyWhiteListResponse, DescribeVpcAcRuleRequest, DeleteRemoteAccessDomainResponse, DescribeSwitchListsRequest, AddAclRuleResponse, DescribeIpsModeSwitchRequest, RemoveVpcAcRuleRequest, DeleteRemoteAccessDomainRequest, SetNatFwEipResponse, DescribeLogStorageStatisticResponse, ModifyStorageSettingResponse, DescribeSwitchErrorRequest, DescribeNatFwInstancesInfoRequest, ModifyBlockIgnoreRuleNewResponse, DescribeSourceAssetRequest, DescribeCfwInsStatusRequest, DescribeSourceAssetResponse, DescribeFwGroupInstanceInfoRequest, DescribeEnterpriseSGRuleProgressRequest, DescribeTLogIpListRequest, ModifyVpcAcRuleRequest, DescribeLogStorageStatisticRequest, AddVpcAcRuleRequest, DescribeTableStatusRequest, ModifyNatSequenceRulesResponse, StopSecurityGroupRuleDispatchResponse, DescribeAssetSyncResponse, ModifyVpcFwSequenceRulesRequest, DescribeSecurityGroupListRequest, ModifyAddressTemplateResponse, CreateNatFwInstanceResponse, DescribeNatFwInfoCountResponse, UpdateClusterVpcFwResponse, DescribeCcnVpcFwPolicyLimitRequest, DescribeDefenseSwitchRequest, ModifyVpcFwGroupRequest, ModifyEnterpriseSecurityDispatchStatusResponse, ModifyResourceGroupRequest, DescribeCcnAssociatedInstancesRequest, ModifyClusterVpcFwSwitchRequest, CreateNatFwInstanceWithDomainResponse, DescribeFwSyncStatusRequest, ModifyEnterpriseSecurityGroupRuleRequest, RemoveNatAcRuleRequest, ModifySequenceRulesResponse, DescribeAssetSyncRequest, DeleteVpcFwGroupRequest, DescribeAcListsResponse, ModifyAcRuleRequest, ModifySequenceAclRulesResponse, CreateAddressTemplateRequest, CreateBlockIgnoreRuleNewResponse, AddNatAcRuleRequest, ModifySecurityGroupSequenceRulesRequest, CreateDatabaseWhiteListRulesResponse, DeleteBlockIgnoreRuleListRequest, SyncFwOperateResponse, DeleteVpcFwGroupResponse, CreateChooseVpcsResponse, DescribeUnHandleEventTabListResponse, ModifyRunSyncAssetResponse, AddVpcAcRuleResponse, DescribeSecurityGroupListResponse, DescribeVpcAcRuleResponse, AddEnterpriseSecurityGroupRulesResponse, RemoveEnterpriseSecurityGroupRuleRequest, DescribeCfwInsStatusResponse, DeleteResourceGroupRequest, DescribeFwGroupInstanceInfoResponse, DescribeBlockByIpTimesListRequest, ModifyBlockTopRequest, RemoveEnterpriseSecurityGroupRuleResponse, DescribeEnterpriseSecurityGroupRuleListRequest, CreateAddressTemplateResponse, DescribeTableStatusResponse, ModifySequenceAclRulesRequest, DescribeNatFwInstanceResponse, CreateAlertCenterOmitResponse, DescribeResourceGroupNewResponse, ModifyEdgeIpSwitchResponse, DescribeResourceGroupNewRequest, DescribeAddressTemplateListRequest, RemoveAclRuleRequest, DeleteAcRuleResponse, DescribeIPStatusListRequest, DescribeNatFwDnatRuleResponse, ModifyNatFwVpcDnsSwitchRequest, DescribeFwSyncStatusResponse, DeleteNatFwInstanceRequest, ModifyAllRuleStatusRequest, SetNatFwDnatRuleResponse, DescribeDefenseSwitchResponse, DescribeAcListsRequest, DescribeGuideScanInfoRequest, DescribeAssociatedInstanceListRequest, ModifyVpcAcRuleResponse, DescribeVpcFwCcnPolicyWhiteListRequest, ModifyBlockIgnoreRuleNewRequest, ModifyEWRuleStatusRequest, DeleteAcRuleRequest, ModifyNatFwSwitchRequest, DeleteBlockIgnoreRuleNewRequest, DescribeSwitchErrorResponse, DescribeCcnVpcFwSwitchRequest, DescribeFwEdgeIpsResponse, DescribeIPStatusListResponse, CreateDatabaseWhiteListRulesRequest, DescribeResourceGroupRequest, DescribeVpcFwGroupSwitchResponse, ModifyBlockIgnoreRuleResponse, DescribeCcnAssociatedInstancesResponse, DescribeTLogIpListResponse, DescribeNatFwInfoCountRequest, UpdateCheckCcnNonDirectFlagResponse, RemoveAcRuleRequest, ModifyNatFwReSelectRequest, ModifyVpcFwSequenceRulesResponse, SetNatFwDnatRuleRequest, ModifyAllRuleStatusResponse, StopSecurityGroupRuleDispatchRequest, SetNatFwEipRequest, DescribeBlockIgnoreListRequest, DescribeClusterVpcFwSwitchsResponse, ModifyBlockTopResponse, RemoveAclRuleResponse, DescribeBlockByIpTimesListResponse, ModifySecurityGroupItemRuleStatusRequest, ModifyStorageSettingRequest, ModifyAssetSyncRequest, DescribeNatFwVpcDnsLstResponse, CreateBlockIgnoreRuleListResponse, ExpandCfwVerticalResponse, DescribeBlockStaticListRequest, DescribeLogsResponse, CreateSecurityGroupRulesRequest, CreateVpcFwGroupRequest, CreateNatFwInstanceWithDomainRequest, DescribeNatFwSwitchRequest, DescribeRuleOverviewRequest, RemoveNatAcRuleResponse, DescribeNatFwSwitchResponse, DescribeResourceGroupResponse, DeleteAddressTemplateResponse, DescribeCfwEipsResponse, ModifyResourceGroupResponse, ModifyVpcFwGroupResponse, DeleteResourceGroupResponse, SearchLogRequest, DeleteSecurityGroupRuleRequest, CreateAlertCenterIsolateRequest, DescribeIpsModeSwitchResponse, DescribeNatAcRuleRequest, DescribeEnterpriseSecurityGroupRuleListResponse, ModifyRunSyncAssetRequest, DeleteAddressTemplateRequest, CreateAcRulesResponse, DescribeSwitchListsResponse, DescribeCcnInstanceRegionStatusResponse, RemoveVpcAcRuleResponse, DescribeNatFwInstancesInfoResponse, AddNatAcRuleResponse, ModifyBlockIgnoreListResponse, ModifySecurityGroupRuleResponse, DescribeFwEdgeIpsRequest, DescribeClusterVpcFwSwitchsRequest, CreateAcRulesRequest, ModifyEnterpriseSecurityDispatchStatusRequest, ModifyNatAcRuleResponse, ModifyNatInstanceResponse, ModifyTableStatusRequest, ModifyTableStatusResponse, DescribeCcnVpcFwSwitchResponse, DescribeBlockStaticListResponse, DescribeGuideScanInfoResponse, CreateAlertCenterRuleResponse, DescribeAddressTemplateListResponse } from "./cfw_models";
/**
 * cfw client
 * @class
 */
export declare class Client extends AbstractClient {
     ...
     * 查询集群模式Vpc间防火墙开关
     */
    DescribeClusterVpcFwSwitchs(req: DescribeClusterVpcFwSwitchsRequest, cb?: (error: string, rep: DescribeClusterVpcFwSwitchsResponse) => void): Promise<DescribeClusterVpcFwSwitchsResponse>;
    /**
     * VPC防火墙(组)开关列表
     */
...
VPC间规则需指定EdgeId。Nat边界规则需指定地域Region与Direction。
     ...
     * 修改入侵防御防护模式
     */
    ModifyIpsModeSwitch(req: ModifyIpsModeSwitchRequest, cb?: (error: string, rep: ModifyIpsModeSwitchResponse) => void): Promise<ModifyIpsModeSwitchResponse>;
    /**
     ...
     * 查询NAT边界防火墙开关列表
     */
    DescribeNatFwSwitch(req: DescribeNatFwSwitchRequest, cb?: (error: string, rep: DescribeNatFwSwitchResponse) => void): Promise<DescribeNatFwSwitchResponse>;
    /**
     * vpc间规则快速排序
     */
     ...
     */
    DescribeCcnVpcFwPolicyLimit(req?: DescribeCcnVpcFwPolicyLimitRequest, cb?: (error: string, rep: DescribeCcnVpcFwPolicyLimitResponse) => void): Promise<DescribeCcnVpcFwPolicyLimitResponse>;
    /**
     * 编辑新企业安全组规则
     */
...
批量修改封禁IP、放通IP/域名生效事件
     ...
     * 获取入侵防御防护模式
     */
    DescribeIpsModeSwitch(req?: DescribeIpsModeSwitchRequest, cb?: (error: string, rep: DescribeIpsModeSwitchResponse) => void): Promise<DescribeIpsModeSwitchResponse>;
    /**
     * 查询地址模板列表
     */
