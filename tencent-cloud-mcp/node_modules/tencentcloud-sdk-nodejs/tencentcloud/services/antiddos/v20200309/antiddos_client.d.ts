...
export declare class Client extends AbstractClient {
     ...
     */
    DescribeListProtectThresholdConfigNew(req: DescribeListProtectThresholdConfigNewRequest, cb?: (error: string, rep: DescribeListProtectThresholdConfigNewResponse) => void): Promise<DescribeListProtectThresholdConfigNewResponse>;
    /**
     * 获取单IP告警阈值配置列表
     */
     ...
     * 通过API 购买高防包接口
     */
    CreateBgpInstance(req: CreateBgpInstanceRequest, cb?: (error: string, rep: CreateBgpInstanceResponse) => void): Promise<CreateBgpInstanceResponse>;
    /**
     * 获取DDoS防护的区域封禁配置列表
     */
     ...
     * 购买后，查询购买的高防包实例信息
     */
    DescribeBgpInstances(req: DescribeBgpInstancesRequest, cb?: (error: string, rep: DescribeBgpInstancesResponse) => void): Promise<DescribeBgpInstancesResponse>;
    /**
     * 获取DDoS防护的IP黑白名单列表
     */
