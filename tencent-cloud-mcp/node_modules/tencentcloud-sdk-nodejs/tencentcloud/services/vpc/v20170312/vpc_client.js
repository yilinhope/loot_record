...
- 支持对弹性公网 IPv6 和传统弹性公网 IPv6 实例名称进行修改。
     ...
     * 修改流量镜像五元组过滤规则。
     */
    async ModifyTrafficMirrorFilterRules(req, cb) {
...
* 创建安全组同时可以绑定标签, 应答里的标签列表代表添加成功的标签。
     ...
     * 查询流量镜像五元组过滤规则。
     */
    async DescribeTrafficMirrorFilterRules(req, cb) {
...
* 删除私有网络是不可逆的操作，请谨慎处理。
     ...
     */
    async DescribeDesignatedZones(req, cb) {
...
* 只有状态为 BIND 和 BIND_ENI 的 EIP 才能进行解绑定操作。
     ...
     * 创建流量镜像五元组过滤规则。
     */
    async CreateTrafficMirrorFilterRules(req, cb) {
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询[DescribeVpcTaskResult](https://cloud.tencent.com/document/api/215/59037) 接口。
     ...
     * 删除流量镜像五元组过滤规则。
     */
    async DeleteTrafficMirrorFilterRules(req, cb) {
