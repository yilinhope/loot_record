...
export declare class Client extends AbstractClient {
     ...
     * 删除泳道组
     */
    DeleteGovernanceLaneGroups(req: DeleteGovernanceLaneGroupsRequest, cb?: (error: string, rep: DeleteGovernanceLaneGroupsResponse) => void): Promise<DeleteGovernanceLaneGroupsResponse>;
    /**
     * 获取云原生网关服务详情
     */
     ...
     * 创建泳道组
     */
    CreateGovernanceLaneGroups(req: CreateGovernanceLaneGroupsRequest, cb?: (error: string, rep: CreateGovernanceLaneGroupsResponse) => void): Promise<CreateGovernanceLaneGroupsResponse>;
    /**
     * 删除配置文件分组
     */
     ...
     * 创建或编辑云原生网关跨域配置
     */
    CreateOrModifyCloudNativeAPIGatewayCORS(req: CreateOrModifyCloudNativeAPIGatewayCORSRequest, cb?: (error: string, rep: CreateOrModifyCloudNativeAPIGatewayCORSResponse) => void): Promise<CreateOrModifyCloudNativeAPIGatewayCORSResponse>;
    /**
     * 查看弹性伸缩策略列表
     */
     ...
     * 查询云原生网关跨域配置
     */
    DescribeCloudNativeAPIGatewayCORS(req: DescribeCloudNativeAPIGatewayCORSRequest, cb?: (error: string, rep: DescribeCloudNativeAPIGatewayCORSResponse) => void): Promise<DescribeCloudNativeAPIGatewayCORSResponse>;
}
